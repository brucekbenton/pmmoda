...
{
    public class ReferenceComponentController : ApiController
    {
        public HttpResponseMessage GetReferenceComponents(int TypeID)
        {
            ...
            {
                values = ReferenceComponent.LoadList(TypeID);
                response = new HttpResponseMessage(HttpStatusCode.OK);
