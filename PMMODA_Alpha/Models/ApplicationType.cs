...
namespace PMMODA_Alpha.Models
{
    public class ApplicationType
    {
        ...
        /// <summary>
        /// Load the set of defined Application Types from the datastore
        /// </summary>
        /// <returns></returns>
        public static List<ApplicationType> LoadList()
        {
            ...
            try
            {
                ...
                using (connection = new SqlConnection(Authentication.ConnectionString))
                {
                    ...
                    {
                        cmdString = "EXEC ApplicationTypeListGet ";
                        ...
                        while (reader.Read())
                        {
                            ...
                            type.TypeID = Convert.ToInt32(reader[recordCount++]);
                            type.Name = reader[recordCount++].ToString();
                            type.Description = reader[recordCount++].ToString();
                            type.isActive = Convert.ToBoolean(reader[recordCount++]);
                            values.Add(type);
                            recordCount = 0;
                        }
                        reader.Close();
